...
-- Check for NULLs or Negeative Values in Cost
-- Expecations: No Results
SELECT
  prd_cost
FROM silver.crm_ord_info
...
-- Check for Invalid Date Orders (Order dDate > Shipping/Due Dates)
-- Expecatations: No Results
SELECT
  *
